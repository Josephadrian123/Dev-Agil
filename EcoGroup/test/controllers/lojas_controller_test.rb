...
class LojasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create loja" do
    assert_difference('Loja.count') do
      post lojas_url, params: { loja: { cnpj: @loja.cnpj, nomeFantasia: @loja.nomeFantasia, usuario_id: @loja.usuario_id } }
    end
  ...
  test "should update loja" do
    patch loja_url(@loja), params: { loja: { cnpj: @loja.cnpj, nomeFantasia: @loja.nomeFantasia, usuario_id: @loja.usuario_id } }
